...
public class GetStudentById extends HttpServlet {
    ...
    static final String DB_URL = "jdbc:mysql://180.76.112.173/linux_final";
    static final String USER = "root";
    static final String PASS = "19816285010Liu!";
    static final String SQL_SELECT_STUDENT_BY_ID = "SELECT id, name,age FROM t_student WHERE id=?";
    static final String REDIS_URL = "180.76.112.173";
